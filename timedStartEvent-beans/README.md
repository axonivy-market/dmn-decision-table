...
## Installation
1. Download the `timedStartEvent-bean_XYZ.jar` from the [latest release](https://github.com/ivy-supplements/bpm-beans/releases/latest)
2. Copy the downloaded JAR into a directory in our project (e.g. `myProject/lib/timedStartEvent-bean_XYZ.jar`)
