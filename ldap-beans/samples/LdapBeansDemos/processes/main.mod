[Ivy]
[>Created: Tue Jul 04 16:37:54 CEST 2017]
...
mn0 f0 callSignature query() #txt
...
mn0 f3 beanConfig '"#
#Tue Jul 04 16:37:54 CEST 2017
search_root_object=OU\\=IvyTeam Test-OU,DC\\=zugtstdomain,DC\\=wan
result_return=onylFirst
server_provider=Microsoft Active Directory
search_filter_value_0=test
search_filter_attribute_0=name
server_authkind=simple
server_password=
result_include_name2=false
search_scope=oneObject
