...
public class TimedStartEventBean implements IProcessStartEventBean {
	...
	/**
	 * An editor that is called from the Start Event Bean - inscription mask
	 * used to set configuration parameters for the PI-Bean. Provides the
	...
	public static class Editor extends
		...
		* @see ch.ivyteam.ivy.process.extension.IProcessExtensionConfigurationEditorEx#acceptInput()
		 ...
		 * 
		 * @param textField
		 *            JTextField from which the int should be extracted
		 * @return Int
		 */
		 ...
		 * 
		 * @param number
		 *            Integer, which has to be formated
